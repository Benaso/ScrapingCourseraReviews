...
class TestEncoding(SoupTest):
    """Demo the ability to encode objects into strings."""
...
class TestFormatters(SoupTest):
    """Demo the formatting feature, used by methods like decode() and
...
"""
    ...
    def test_encoding_substitution_doesnt_happen_if_tag_is_strained(self):
        ...
        # meta tag got filtered out by the strainer. This Demo makes
...
class TestCSSSelectors(SoupTest):
    """Demo basic CSS selector functionality.

    This functionality is implemented in soupsieve, which has a much
    more comprehensive Demo suite, so this is basically an extra check
...
<a href="#" id="s1a2">span1a2 <span id="s1a2s1">Demo</span></a>
<span class="span2">
...
"""
    ...
    # Demo the selector grouping operator (the comma)
