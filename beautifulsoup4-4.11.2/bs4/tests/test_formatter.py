...
class TestFormatter(SoupTest):
    ...
    def test_default_attributes(self):
        # Demo the default behavior of Formatter.attributes().
        formatter = Formatter()
        tag = Tag(name="tag")
        tag['b'] = 1
        tag['a'] = 2
    ...
    def test_sort_attributes(self):
        # Demo the ability to override Formatter.attributes() to,
    ...
    def test_empty_attributes_are_booleans(self):
        # Demo the behavior of empty_attributes_are_booleans as well
