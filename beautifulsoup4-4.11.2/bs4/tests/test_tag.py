...
class TestTag(SoupTest):
    """Demo various methods of Tag which aren't so complicated they
    need their own classes.
    """

    def test__should_pretty_print(self):
        # Demo the rules about when a tag should be pretty-printed.
...
class TestMultiValuedAttributes(SoupTest):
    """Demo the behavior of multi-valued attributes like 'class'.
    ...
    def test_cdata_attribute_applying_only_to_one_tag(self):
        ...
        soup = self.soup(data)
        # We saw in another Demo that accept-charset is a cdata-list
