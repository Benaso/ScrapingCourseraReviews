...
class TestConstructor(SoupTest):
    ...
    def test_replacement_classes(self):
        # Demo the ability to pass in replacements for element classes
    ...
    def test_alternate_string_containers(self):
        # Demo the ability to customize the string containers for
...
class TestNewTag(SoupTest):
    """Demo the BeautifulSoup.new_tag() method."""
...
class TestNewString(SoupTest):
    """Demo the BeautifulSoup.new_string() method."""
...
class TestPickle(SoupTest):
   # Demo our ability to pickle the BeautifulSoup object itself.
...
class TestEncodingConversion(SoupTest):
    # Demo Beautiful Soup's ability to decode and encode from various
    # encodings.
