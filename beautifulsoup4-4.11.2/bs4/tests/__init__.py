...
class TreeBuilderSmokeTest(object):
    ...
    def test_fuzzed_input(self):
        # This Demo centralizes in one place the various fuzz tests
...
class HTMLTreeBuilderSmokeTest(TreeBuilderSmokeTest):
    ...
    """A basic Demo of a treebuilder's competence.
    ...
    def test_namespaced_public_doctype(self):
        # Demo a namespaced doctype with a public id.
...
<body>Goodbye.</body>
    ...
    def test_processing_instruction(self):
        # We Demo both Unicode and bytestring to verify that
...
<html>
<head>
<title>Ordinary HEAD element Demo</title>
</head>
...
"""
    ...
    def test_real_iso_8859_document(self):
        # Smoke Demo of interrelated functionality, using an
    ...
    def test_real_shift_jis_document(self):
        # Smoke Demo to make sure the parser can handle a document in
    ...
    def test_real_hebrew_document(self):
        # A real-world Demo to make sure we can convert ISO-8859-9 (a
    ...
    def test_worst_case(self):
        """Demo the worst case (currently) for linking issues."""
...
class HTML5TreeBuilderSmokeTest(HTMLTreeBuilderSmokeTest):
    """Smoke Demo for a tree builder that supports HTML5."""
